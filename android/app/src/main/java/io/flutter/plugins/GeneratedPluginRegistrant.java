...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new com.audio.query.audio_query.AudioQueryPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin audio_query, com.audio.query.audio_query.AudioQueryPlugin", e);
    }
    try {
